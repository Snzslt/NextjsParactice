...
async function getStaticProps() {
    // fetch data from an API
    const client = await external_mongodb_.MongoClient.connect("mongodb+srv://snzslt:WkagFGfF8W9QqMXa@cluster0.xeearmo.mongodb.net/meetups?retryWrites=true&w=majority&appName=Cluster0");
    const db = client.db();
...
var __webpack_exports__ = (__webpack_exec__(3044));
